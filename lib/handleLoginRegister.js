if(Meteor.isClient) {
	...
	Template.registerUser.rendered = function(){
		...
		registerValidator.addRules("registerPasswordRepeat", {"required":true,"matchfield":"registerPassword","nospace":true}, {"alertMsg":"The passwords you entered do not match."});
	};
